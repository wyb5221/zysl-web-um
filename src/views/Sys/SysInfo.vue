  ...
  <div class="container" style="width:99%;margin-top:-25px;">
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size">
			...
			<el-form-item label="系统编码，唯一" prop="code"  v-if="dataForm.isPrimaryKey">
				<el-input v-model="dataForm.code" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="系统名称" prop="name"  v-if="dataForm.isPrimaryKey">
				<el-input v-model="dataForm.name" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="系统描述" prop="remark"  v-if="dataForm.isPrimaryKey">
