  ...
  <div class="container" style="width:99%;margin-top:-25px;">
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size">
			...
			<el-form-item label="系统表主键" prop="sysKey"  v-if="dataForm.isPrimaryKey">
				<el-input v-model="dataForm.sysKey" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="微服务编号" prop="code"  v-if="dataForm.isPrimaryKey">
				<el-input v-model="dataForm.code" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="微服务名称" prop="name"  v-if="dataForm.isPrimaryKey">
				<el-input v-model="dataForm.name" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="网关编号，比如/gate/01,则编号为01" prop="gateCode"  v-if="dataForm.isPrimaryKey">
				<el-input v-model="dataForm.gateCode" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="开发负责人" prop="developer"  v-if="dataForm.isPrimaryKey">
				<el-input v-model="dataForm.developer" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="微服务描述" prop="remark"  v-if="dataForm.isPrimaryKey">
